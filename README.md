...
- **Dev Server URL**: `http://127.0.0.1:5239`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/337cb149-c3c0-45e7-8d71-42f26fa529a0/preview`
- **Port**: `5239`
...
4. The dev server is accessible at `http://127.0.0.1:5239`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/337cb149-c3c0-45e7-8d71-42f26fa529a0/preview`
